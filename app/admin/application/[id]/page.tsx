        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-3">
            <Button
              ...
              className="border-green-500 text-green-600 hover:bg-green-50 hover:text-green-700 text-[10px] px-1 py-1 md:text-sm md:px-3 md:py-2"
            >
              {approveLoading ? (
            ...
            <Button
              ...
              className="border-red-500 text-red-600 hover:bg-red-50 hover:text-red-700 text-[10px] px-1 py-1 md:text-sm md:px-3 md:py-2"
            >
              {rejectLoading ? (
              ...
              <CardContent className="p-6">
                <div className="flex flex-col items-center mb-6">
                  ...
                  <h2 className="text-xl font-bold text-gray-900">
                    {application.first_name || "Unknown"}{" "}
                    {application.last_name || ""}
                  </h2>
                  <p className="text-gray-500">
                    {application.job_title || "No position specified"}
                  </p>
                  <Badge
                    variant={
                      application.status === "approved"
                    ...
                    className={
                      application.status === "approved"
                        ? "bg-green-500 hover:bg-green-600 text-white text-sm px-3 py-1 mt-2"
                        : "text-sm px-3 py-1 mt-2"
                    }
                  >
                    {application.status === "approved" && (
            ...
            <Card className="bg-white shadow-md border-0 overflow-hidden">
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  ...
                  {Array.isArray(application.position_preferences) &&
                    application.position_preferences.length > 0 && (
                      <div>
                        <p className="text-sm text-gray-500">
                          Position Preferences
                        </p>
                        <div className="flex flex-wrap gap-2 mt-1">
                          {application.position_preferences.map(
                            (pref: any, i: number) => (
                              <Badge
                                key={i}
                                variant="outline"
                  ...
                  {Array.isArray(application.department_preferences) &&
                    application.department_preferences.length > 0 && (
                      <div>
                        <p className="text-sm text-gray-500">
                          Department Preferences
                        </p>
                        <div className="flex flex-wrap gap-2 mt-1">
                          {application.department_preferences.map(
                            (dept: any, i: number) => (
                              <Badge
                                key={i}
                                variant="outline"
            ...
            <Card className="bg-white shadow-md border-0 overflow-hidden">
              ...
              <CardContent className="p-6">
                <div className="space-y-6">
                  {Array.isArray(application.computer_skills) &&
                    application.computer_skills.length > 0 && (
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-2">
                          Computer Skills
                        </h3>
                        <div className="flex flex-wrap gap-2">
                          {application.computer_skills.map(
                            (skill: any, i: number) => (
                              <Badge
                                key={i}
                                variant="outline"
                  ...
                  {Array.isArray(application.equipment_skills) &&
                    application.equipment_skills.length > 0 && (
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-2">
                          Equipment Skills
                        </h3>
                        <div className="flex flex-wrap gap-2">
                          {application.equipment_skills.map(
                            (skill: any, i: number) => (
                              <Badge
                                key={i}
                                variant="outline"
                    ...
                    <div>
                      ...
                      {typeof application.college === "string" ? (
                        ...
                        <div>
                          ...
                          {(application.college?.graduation_year ||
                            application.college?.graduated) && (
                            <p className="text-gray-500">
                              Graduated:{" "}
                              {application.college.graduation_year ||
                                application.college.graduated}
